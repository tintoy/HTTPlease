...
namespace HTTPlease.Formatters.Tests
{
	...
	/// <summary>
	///		Factory methods for XML-formatted mocked <see cref="HttpClient"/>s used by tests.
	/// </summary>
	public static class XmlTestClients
    {
		/// <summary>
		...
		/// </param>
		/// <param name="body">
		///		The response body (will be serialised as XML).
		/// </param>
		/// <returns>
		...
		public static HttpClient RespondWith<TBody>(HttpStatusCode statusCode, TBody body)
		{
			return TestClients.RespondWith(
				request => request.CreateResponse(statusCode, body, WellKnownMediaTypes.Xml, new XmlFormatter())
			);
		}

		/// <summary>
		///		Create an <see cref="HttpClient"/> that performs assertions on an incoming request message and returns a predefined (XML-formatted) response.
		/// </summary>
		...
		///		The configured <see cref="HttpClient"/>.
		/// </returns>
		public static HttpClient ExpectXml<TResponseBody>(Uri expectedRequestUri, HttpMethod expectedRequestMethod, TResponseBody responseBody)
		{
			return ExpectXml(expectedRequestUri, expectedRequestMethod, responseBody, assertion: null);
		}
		...
		///		The configured <see cref="HttpClient"/>.
		/// </returns>
		public static HttpClient ExpectXml<TResponseBody>(Uri expectedRequestUri, HttpMethod expectedRequestMethod, TResponseBody responseBody, Action<HttpRequestMessage> assertion)
		{
			return ExpectXml(expectedRequestUri, expectedRequestMethod, HttpStatusCode.OK, responseBody, assertion);
		}
		...
		///		The configured <see cref="HttpClient"/>.
		/// </returns>
		public static HttpClient ExpectXml<TResponseBody>(Uri expectedRequestUri, HttpMethod expectedRequestMethod, HttpStatusCode responseStatusCode, TResponseBody responseBody, Action<HttpRequestMessage> assertion)
		{
			return Expect(expectedRequestUri, expectedRequestMethod, responseStatusCode, responseBody, WellKnownMediaTypes.Xml, new XmlFormatter(), assertion);
		}
		...
		///		The configured <see cref="HttpClient"/>.
		/// </returns>
		public static HttpClient ExpectXml<TResponseBody>(Uri expectedRequestUri, HttpMethod expectedRequestMethod, TResponseBody responseBody, Func<HttpRequestMessage, Task> asyncAssertion)
		{
			return ExpectXml(expectedRequestUri, expectedRequestMethod, HttpStatusCode.OK, responseBody, asyncAssertion);
		}
		...
		///		The configured <see cref="HttpClient"/>.
		/// </returns>
		public static HttpClient ExpectXml<TResponseBody>(Uri expectedRequestUri, HttpMethod expectedRequestMethod, HttpStatusCode responseStatusCode, TResponseBody responseBody, Func<HttpRequestMessage, Task> asyncAssertion)
		{
			return Expect(expectedRequestUri, expectedRequestMethod, responseStatusCode, responseBody, WellKnownMediaTypes.Xml, new XmlFormatter(), asyncAssertion);
		}
