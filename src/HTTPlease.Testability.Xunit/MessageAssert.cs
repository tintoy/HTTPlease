...
namespace HTTPlease.Testability
{
	...
	public static class MessageAssert
    {
		...
		/// </param>
		public static void FromRequest(HttpRequest request, HttpMethod method, Action<HttpRequestMessage> assertion)
		{
			FromRequest(request, method,
				bodyContent: null,
				baseUri: null,
				assertion: assertion
			);
		...
		///		A delegate that makes assertions about the <see cref="HttpRequestMessage"/>.
		/// </param>
		public static void FromRequest(HttpRequest request, HttpMethod method, Uri baseUri, Action<HttpRequestMessage> assertion)
		{
			FromRequest(request, method,
				bodyContent: null,
				baseUri: baseUri,
		...
		///		A delegate that makes assertions about the <see cref="HttpRequestMessage"/>.
		/// </param>
		public static void FromRequest(HttpRequest request, HttpMethod method, HttpContent bodyContent, Action<HttpRequestMessage> assertion)
		{
			FromRequest(request, method, bodyContent, null, assertion);
		}
		...
		///		A delegate that makes assertions about the <see cref="HttpRequestMessage"/>.
		/// </param>
		public static void FromRequest(HttpRequest request, HttpMethod method, HttpContent bodyContent, Uri baseUri, Action<HttpRequestMessage> assertion)
		{
			if (request == null)
		...
		/// </param>
		public static async Task FromRequestAsync(HttpRequest request, HttpMethod method, HttpContent bodyContent, Uri baseUri, Func<HttpRequestMessage, Task> asyncAssertion)
		{
			if (request == null)
				throw new ArgumentNullException(nameof(request));
		...
		/// </remarks>
		public static void FromRequest<TContext>(HttpRequest<TContext> request, HttpMethod method, Action<HttpRequestMessage> assertion)
		{
			FromRequest(request, method,
		...
		///		Uses the default value for <typeparamref name="TContext"/>.
		/// </remarks>
		public static void FromRequest<TContext>(HttpRequest<TContext> request, HttpMethod method, Uri baseUri, Action<HttpRequestMessage> assertion)
		{
			FromRequest(request, method,
				context: default(TContext),
				bodyContent: null,
		...
		///		A delegate that makes assertions about the <see cref="HttpRequestMessage"/>.
		/// </param>
		public static void FromRequest<TContext>(HttpRequest<TContext> request, HttpMethod method, TContext context, Action<HttpRequestMessage> assertion)
		{
			FromRequest(request, method, context,
				bodyContent: null,
				baseUri: null,
				assertion: assertion
			);
		...
		///		A delegate that makes assertions about the <see cref="HttpRequestMessage"/>.
		/// </param>
		public static void FromRequest<TContext>(HttpRequest<TContext> request, HttpMethod method, TContext context, Uri baseUri, Action<HttpRequestMessage> assertion)
		{
			FromRequest(request, method, context,
				bodyContent: null,
				baseUri: baseUri,
		...
		///		A delegate that makes assertions about the <see cref="HttpRequestMessage"/>.
		/// </param>
		public static void FromRequest<TContext>(HttpRequest<TContext> request, HttpMethod method, TContext context, HttpContent bodyContent, Action<HttpRequestMessage> assertion)
		{
			FromRequest(request, method, context, bodyContent,
				baseUri: null,
				assertion: assertion
			);
		}
		...
		///		A delegate that makes assertions about the <see cref="HttpRequestMessage"/>.
		/// </param>
		public static void FromRequest<TContext>(HttpRequest<TContext> request, HttpMethod method, TContext context, HttpContent bodyContent, Uri baseUri, Action<HttpRequestMessage> assertion)
		{
			if (request == null)
				throw new ArgumentNullException(nameof(request));
		...
		///		An asynchronous delegate that makes assertions about the <see cref="HttpRequestMessage"/>.
		/// </param>
		public static async Task FromRequestAsync<TContext>(HttpRequest<TContext> request, HttpMethod method, TContext context, HttpContent bodyContent, Uri baseUri, Func<HttpRequestMessage, Task> asyncAssertion)
		{
			if (request == null)
				throw new ArgumentNullException(nameof(request));
