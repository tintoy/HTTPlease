...
namespace HTTPlease.Core
{
	...
	/// </summary>
	public abstract class HttpRequestBase2
		: IHttpRequestProperties2
	{
		...
		///		The request properties.
		/// </param>
		protected HttpRequestBase2(IRequestPropertyStore properties)
		{
			if (properties == null)
		...
		///		The cloned request.
		/// </returns>
		public virtual HttpRequestBase2 Clone(Action<IDictionary<string, object>> modifications)
		{
			if (modifications == null)
				throw new ArgumentNullException(nameof(modifications));
		...
		/// </returns>
		protected abstract HttpRequestBase2 CreateInstance(IRequestPropertyStore requestProperties);
